...
object ExportRows {
    ...
    fun orderedChecklistKeys(house: ExportHouse): List<String> {
        val builtIn = com.househunt.shared.model.Checklist.keys.filter { house.checklist.containsKey(it) }
        val extra = house.checklist.keys.filter { it !in com.househunt.shared.model.Checklist.keys }.sorted()
