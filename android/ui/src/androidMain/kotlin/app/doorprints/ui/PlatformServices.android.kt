 ...
 * activity): the location rationale needs the activity ([canAskLocation]); everything else reads the application
 * context. Created per composition by [ProvidePlatformServices]; never held by a view model or a service.
 */
