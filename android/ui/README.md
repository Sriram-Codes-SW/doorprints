...
| Version | Date | Change |
|---|---|---|
| 1.7 | 2026-09-24 | **CMP-4 P4a done in code** (branch `claude/doorprints-dev-continue-fzcge2`; [docs/03](../../docs/03-design.md) ADR-23 P4a, [docs/10](../../docs/10-sprint-log.md) §13.6): the Room database is in `:shared` commonMain (Room KMP); section 6's P4 row says so. No change to `:ui` itself. |
