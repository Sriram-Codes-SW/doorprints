...
API 26, 34 and 36 (`android-emulator.yml`). The emulator lays out but does not draw the map's labels (S4b-BL-48). A phase that changes a screen on purpose re-records with `./gradlew :app:recordRoborazziDebug`
