...
object ExportGrants {
    ...
    private fun settingsOf(app: Context) = (app as HouseHuntApp).container.settings
}
 ...
 *
 * Pure and free of Android types, like [oldestBeyondRetention], so `ExportGrantsTest` pins it on the JVM.
 */
