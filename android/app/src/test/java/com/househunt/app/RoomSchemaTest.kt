 ...
 * the same value is in the committed schemas/com.househunt.app.data.AppDatabase/2.json.
 *
...
class RoomSchemaTest {
    ...
    private companion object {
        ...
        const val SCHEMA_PATH = "schemas/com.househunt.app.data.AppDatabase/2.json"
    }
