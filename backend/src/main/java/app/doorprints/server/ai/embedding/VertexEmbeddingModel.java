...
import app.doorprints.server.ai.embedding.GeminiEmbeddingModel.Content;
import app.doorprints.server.ai.embedding.GeminiEmbeddingModel.ContentEmbedding;
import app.doorprints.server.ai.embedding.GeminiEmbeddingModel.GeminiEmbeddingException;
import app.doorprints.server.ai.embedding.GeminiEmbeddingModel.Part;
