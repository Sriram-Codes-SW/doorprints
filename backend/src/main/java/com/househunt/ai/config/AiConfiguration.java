 ...
 * {@code com.househunt.ai.embedding.GeminiEmbeddingConfiguration} ({@code app.ai.embedding.provider=google-genai},
 * default) or the OpenAI-compatible auto-configuration ({@code openai}). With {@code app.ai.provider=vertex} chat comes
 * from Spring AI's Google GenAI auto-configuration and embeddings from {@code com.househunt.ai.embedding.VertexEmbeddingModel},
 * both through {@code com.househunt.ai.vertex.VertexAiConfiguration}. PgVectorStore from its auto-configuration.
