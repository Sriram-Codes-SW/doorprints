...
(Nepal-China-India, and Doklam) India's outline and the tiles' neighbour lines meet in small loops of about 3-5 km,
because Natural Earth and OpenStreetMap put the tri-junctions a few km apart; and while closer tiles load, or offline without them, the
