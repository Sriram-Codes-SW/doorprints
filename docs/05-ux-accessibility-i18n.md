...
because Natural Earth and OpenStreetMap put the tri-junctions a few km apart: about 13 x 3 km at Nepal-China-India (on glaciers, seen only from about zoom 10) and about 2 km at Doklam; at two hand-overs the tile line runs on past the hand-over and stops in open ground, from zoom 11: about 9 km at Jomotsangkha (Bhutan's south-east corner) and about 3 km at Longwa (Nagaland-Myanmar); and while closer tiles load, or offline without them, the
