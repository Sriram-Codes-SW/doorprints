...
| TC-AI-10 after the Sprint 3 embedding and scorecard fixes | The first real run (C-07) failed on embeddings and reported a false PASS; TC-AI-11..14 cover the fixes without a model, but no real scorecard exists yet | Re-run `ai-evals.yml` once CI is green and record the scorecard in [10](10-sprint-log.md) §5.2 (E-01, E-02) |
