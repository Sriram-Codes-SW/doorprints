...
| Id | Item | Owner | Notes |
|---|---|---|---|
| N1 | **Finish PR #14 review**: Docs and Android managers review only the delta since `3ad2b58` (text only). Apply fixes on `fix/india-boundaries`. | Docs, Android | Safe to merge as it is; no behaviour change. |
