...
flowchart LR
    ...
    subgraph and["android.yml"]
        a1["JDK 21 + setup-gradle<br/>(wrapper validation, cache)"] --> a2["assembleDebug testDebugUnitTest<br/>:shared:testAndroidHostTest<br/>:ui:testAndroidHostTest<br/>commonMain metadata compile"]
