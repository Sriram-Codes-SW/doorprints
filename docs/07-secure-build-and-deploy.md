...
| Artifacts | APK 30 days, backend SBOM 30 days, web dist 14 days, emulator results (`android-emulator-results-api-<level>`) 14 days, reports 7 days (including the screenshot diffs in `android-reports`) |
