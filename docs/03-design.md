...
The file was `househunt.db` until 2026-09-24 (ADR-24); `DatabaseFile.resolve` renames an existing one, with its `-wal`, `-shm` and `-journal` files, before Room opens it.
