...
| `iosMain` | `iosAppDatabase()` (CMP-4 P4a): `doorprints.db` in Documents with the bundled SQLite driver, compile-only; later `ktor-client-darwin` | – |
