 ...
 *
 * Why not `crypto.subtle.digest`: it is only available in a secure context, and it is asynchronous, which would
 * make every exporter async and untestable in the jsdom unit-test environment. The hashes here are integrity
